...
class Book implements Comparable<Book> {
	...
	public int compareTo(Book ob) {
		int diff=Double.compare(this.price,ob.getPrice());
		return diff;
	}
	
}
//Use TreeSet to store all books in descending order of price. Natural ordering for
//the Book should be isbn (do not change it). Display them using iterator()
...
public class Library4{
	...
	public static void main(String[] args) {
		...
		Iterator<Book> itr=b.descendingIterator();
